...
<style>
    ...
    .general-deeper, .statics-deeper, .study-deeper, .conduct-deeper {
        max-height: 0;
        overflow: hidden;
    ...
    .statics-deeper, .study-deeper, .conduct-deeper {
        display: flex;
        flex-direction: column;
        align-items: flex-start;
        align-self: stretch;
    ...
    .general-2, .statics, .study-2, .conduct-2 {
        display: flex;
        justify-content: space-between;
        align-items: center;
        align-self: stretch;
    ...
    .general-deeper, .student, .conduct, .list, .reverse, .category, .fault {
        display: flex;
        height: 30px;
