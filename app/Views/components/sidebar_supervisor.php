<div class="sidebar-supervisor">
    ...
    <div class="statics-deeper">
        <div class="student pointer">
            <p>Học sinh</p>
        </div>
...
<style>
    ...
    .general, .study, .conduct-management {
        display: flex;
        flex-direction: column;
    ...
    .general h1, .study h1, .fee h1, .conduct-management h1 {
    ...
    .text p, .general-deeper p, .statics-deeper p, .student p, .conduct p, .list p, .reverse p,
    .category p, .fault p {
        color: #000;
        font-family: Inter;
        font-size: 16px;
    ...
    .student, .conduct, .list, .reverse, .category, .fault {
        display: flex;
        height: 30px;
        padding: 0px 35px;
        align-items: center;
