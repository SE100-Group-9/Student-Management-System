            ...
            <tbody>
                <?php foreach ($studentlist as $index => $student): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/sms/public/director/student/update/<?= $student['MaHocSinh'] ?>">
                            ...
                            <?php if ($student['TinhTrang'] == 'Mới tiếp nhận'): ?>
                                <a style="text-decoration: none; background: none; color: inherit;" title="Xóa"
                                    href="<?= base_url('director/student/delete/' . $student['MaHocSinh']) ?>"
                                    onclick="return confirm('Bạn có chắc chắn muốn xóa học sinh <?= $student['HoTen'] ?> - <?= $student['MaHocSinh'] ?> khỏi hệ thống?');">
