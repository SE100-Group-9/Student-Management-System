                ...
                <tr>
                    ...
                    <td>
                        <a style="text-decoration: none; background: none; color: inherit;" title="Xóa"
                            href="<?= base_url('director/class/arrange/teacher/delete/' . $teacher['MaGV']) . '?' . http_build_query([
                                        'NamHoc' => $selectedYear,
                                        'MaLop' => $MaLop,
                                        'HocKy' => $selectedSemester,
                                        'MaMH' => $teacher['MaMH']
                                    ]) ?>"
                            onclick="return confirm('Bạn có chắc chắn muốn xóa giáo viên <?= $teacher['HoTen'] ?> - <?= $teacher['MaGV'] ?> khỏi lớp học này?');">
