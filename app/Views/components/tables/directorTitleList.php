...
<div id="confirm-dialog" class="dialog-overlay" style="display: none;">
    <div class="dialog-box">
        <div class="content">
            <p>Xóa thanh toán</p>
            <div>
                <h1>Bạn có muốn xóa danh hiệu?</h1>
            </div>
        </div>
        <div class="button-section">
            <button id="cancel-delete" class="cancel-btn">Không</button>
            <button id="confirm-delete" class="confirm-btn">Có</button>
        </div>
    </div>
</div>
...
<script>
    ...
    // Khi nhấn "Xóa", thực hiện xóa
    confirmDelete.addEventListener('click', function() {
        alert('Đã xóa!');
        confirmDialog.style.display = 'none';
    });

    // Khi nhấn "Hủy", đóng hộp thoại
