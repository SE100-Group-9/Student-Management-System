                    ...
                    <tr>
                        ...
                        <td>
                            <a style="text-decoration: none; background: none; color: inherit;" title="Xóa"
                                href="<?= base_url('director/class/arrange/student/delete/' . $student['MaHS']) . '?' . http_build_query([
                                            'NamHoc' => $selectedYear,
                                            'MaLop' => $MaLop
                                        ]) ?>"
                                onclick="return confirm('Bạn có chắc chắn muốn xóa học sinh <?= $student['HoTen'] ?> - <?= $student['MaHS'] ?> khỏi lớp học này?');">
