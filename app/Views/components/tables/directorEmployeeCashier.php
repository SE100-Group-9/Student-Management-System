<?php if (!empty($cashierList) && is_array($cashierList)): ?>
    <div id="table-container">
        <table id="directorEmployeeCashier">
            <thead>
                <tr>
                    <th>STT</th>
                    <th>Mã TN</th>
            ...
            <tbody>
                <?php foreach ($cashierList as $index => $cashier): ?>
                    <tr>
                        <td><?= $index + 1 ?></td>
                        <td><?= $cashier['MaTN'] ?></td>
                        <td><?= $cashier['HoTen'] ?></td>
                        ...
                        <td>
                            <?= view('components/status', ['status' => $cashier['TinhTrang']]); ?>
                        </td>
                        <td>
                            <a href="/sms/public/director/employee/cashier/update/<?= $cashier['MaTN'] ?>">
                            ...
                            <a href="/sms/public/director/employee/cashier/delete/<?= $cashier['MaTN'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa thu ngân này?');">
...
<style>
    ...
    #directorEmployeeCashier a {
        text-decoration: none;
        background-color: transparent;
    }

    #directorEmployeeCashier svg:hover {
        cursor: pointer;
    }
