<?php if (!empty($studentList['PerformanceDetails']['Trung bình']) && is_array($studentList['PerformanceDetails']['Trung bình'])): ?>
    <table id="teacherRecordGood">
        ...
        <?php foreach ($studentList['PerformanceDetails']['Trung bình'] as $student): ?>
            <tr>
                <td><?= $student['STT'] ?></td>
                <td><?= $student['MaHS'] ?></td>
                <td><?= $student['HoTen'] ?></td>
