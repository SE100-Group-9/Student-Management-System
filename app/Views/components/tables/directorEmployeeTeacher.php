<?php if (!empty($teacherList) && is_array($teacherList)): ?>
    <div id="table-container">
        <table id="directorEmployeeTeacher">
            <thead>
                <tr>
                    <th>STT</th>
                    <th>Mã GV</th>
            ...
            <tbody>
                <?php foreach ($teacherList as $index => $teacher): ?>
                    <tr>
                        ...
                        <td>
                            <?= view('components/status', ['status' => $teacher['ChucVu']]); ?>
                        </td>
                        <td>
                            <?= view('components/status', ['status' => $teacher['TinhTrang']]); ?>
                        </td>
                        <td>
                            <a href="/sms/public/director/employee/teacher/update/<?= $teacher['MaGV'] ?>">
                            ...
                            <a href="/sms/public/director/employee/teacher/delete/<?= $teacher['MaGV'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa giáo viên này?');">
...
<style>
    ...
    #directorEmployeeTeacher a {
        text-decoration: none;
        background-color: transparent;
    }

    #directorEmployeeTeacher svg:hover {
        cursor: pointer;
    }
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const tableElement = document.getElementById('directorEmployeeTeacher');
