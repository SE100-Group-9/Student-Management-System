<div class="viewmore-container">
    <button id="button-viewmore" class="button-viewmore">
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
            <path d="M11.5 18.5C11.5 19.0523 11.9477 19.5 12.5 19.5C13.0523 19.5 13.5 19.0523 13.5 18.5C13.5 17.9477 13.0523 17.5 12.5 17.5C11.9477 17.5 11.5 17.9477 11.5 18.5Z" stroke="#0C0C0D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M11.5 12.5C11.5 13.0523 11.9477 13.5 12.5 13.5C13.0523 13.5 13.5 13.0523 13.5 12.5C13.5 11.9477 13.0523 11.5 12.5 11.5C11.9477 11.5 11.5 11.9477 11.5 12.5Z" stroke="#0C0C0D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M11.5 6.5C11.5 7.05228 11.9477 7.5 12.5 7.5C13.0523 7.5 13.5 7.05228 13.5 6.5C13.5 5.94772 13.0523 5.5 12.5 5.5C11.9477 5.5 11.5 5.94772 11.5 6.5Z" stroke="#0C0C0D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    </button>
    ...
    <div id="dropdown-button" class="dropdown-button">
        ...
        <div class="personal">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M14 16H19V21M10 8H5V3M19.4176 9.00316C18.8569 7.61542 17.9181 6.41279 16.708 5.53198C15.4979 4.65117 14.0652 4.12752 12.5723 4.02051C11.0794 3.9135 9.58606 4.2274 8.2627 4.92661C6.93933 5.62582 5.83882 6.68228 5.08594 7.97587M4.58203 14.9968C5.14272 16.3846 6.08146 17.5872 7.29157 18.468C8.50169 19.3488 9.93504 19.8725 11.4279 19.9795C12.9208 20.0865 14.4136 19.7726 15.737 19.0734C17.0603 18.3742 18.1604 17.3178 18.9133 16.0242" stroke="#E14177" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
    </div>
</div>
...
<script>
    ...
    dropdown.style.top = `${buttonPosition.bottom + window.scrollY}px`;  // Đảm bảo dropdown xuất hiện dưới nút
